...
```
Each sub-object of the results can be called as following _object$subobject_
The _area03$tae_ is the Total Absolute Error of the fitting process for this area. 
The  _area03$tries_ holds the TAE of the random selections during the fitting process. This is the error of each combination, even if the combination isn't selected. 
